...
#         }),
#         ('Resume & Documents', {
#             'fields': ('resume', 'resume_preview', 'cover_letter', 'view_cover_letter')
#         }),
...
#         if obj.resume:
#             # Force Cloudinary URL (not local path)
#             try:
#                 # Build full Cloudinary URL
#                 from cloudinary import CloudinaryImage
#                 public_id = obj.resume.name  # This is the Cloudinary public_id
                
#                 # Generate secure Cloudinary URL with download flag
#                 resume_url = CloudinaryImage(public_id).build_url(
#                     secure=True,
#                     resource_type='raw',
#                     flags='attachment'
#                 )
...
#                     resume_url = f"https://res.cloudinary.com/{settings.CLOUDINARY_STORAGE['CLOUD_NAME']}/raw/upload/{obj.resume.name}"
            
#             return format_html(
#                 '<a href="{}" target="_blank" download class="button" style="'
...
#                 download_url = CloudinaryImage(public_id).build_url(
#                     secure=True,
#                     resource_type='raw',
#                     flags='attachment'
#                 )
...
#                     resume_url = f"https://res.cloudinary.com/{cloud_name}/raw/upload/{obj.resume.name}"
